...
"background-color:  #001A27;")
        ...
        global items, cur, past, side_list
        past = 0
        cur = 0

        side_list = main.stock_list()
        # for i in self.crypto:
        #     temp = cd.CoinRankingOHLC(i[6],'minute',i[0],i[1])
        # #     temp.retrieve_data2()
        #     self.coin_list.append(temp)

        items = [listItem(i[0],i[1],i[2],i[3],i[4]) for i in side_list]
...
"    }")
    ...
    def setSelected(self,index):
        _translate = QtCore.QCoreApplication.translate
        symbol,full,price,change,cap = side_list[index]
